...
import app.oways.mykloud.BuildConfig
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideMoviesService(@Named("default_retrofit") retrofit: Retrofit): ToDoServiceApi =
        retrofit.create(ToDoServiceApi::class.java)
